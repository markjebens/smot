/**
 * SpectraNoise — Standalone WebGL animated background
 * Extracted from Framer SpectraNoise component (vanilla JS, no React)
 */
(function () {
    'use strict';
...
`;
    ...
    function initSpectraNoise(canvas, opts) {
        opts = opts || {};
        var hueShift = opts.hueShift != null ? opts.hueShift : 0;
        var noiseIntensity = opts.noiseIntensity != null ? opts.noiseIntensity : 0.02;
        var scanlineIntensity = opts.scanlineIntensity != null ? opts.scanlineIntensity : 0;
        var speed = opts.speed != null ? opts.speed : 0.35;
        var scanlineFrequency = opts.scanlineFrequency != null ? opts.scanlineFrequency : 0;
        var warpAmount = opts.warpAmount != null ? opts.warpAmount : 0.15;
        var resolutionScale = opts.resolutionScale != null ? opts.resolutionScale : 0.5;
        ...
        render();
        return { destroy: function () { cancelAnimationFrame(animFrame); } };
    }

    window.initSpectraNoise = initSpectraNoise;
})();
